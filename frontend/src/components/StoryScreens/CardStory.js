        ...
        <Container className="story-content">
          ...
          <Row className="additional-info">
            <Col md="12">
              ...
              <p className="contact-info"><strong>Contact Information:</strong> For inquiries, contact our support at <a href="mailto:albatrossexpress1968@gmail.com">albatrossexpress1968@gmail.com</a>.</p>
            </Col>
          </Row>
        </Container>
      </Container>
